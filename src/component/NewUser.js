...
const passwordMatchHandler = (e) =>{
    ...
    return (
        <div>
        <Typography style={{textAlign:'center'}} variant="h5" component="div"> Create New User</Typography>
            <FormControl  fullWidth variant="standard">
              ...
              className="user_name_signup"
                ...
                fullWidth
              />
              <Button type="submit" variant="contained" onClick={registerHandler}>Create</Button> 
            </FormControl>
        </div>
    )
}
